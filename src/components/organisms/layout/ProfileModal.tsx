...
export default function ProfileModal() {
  ...
  return (
    ...
    >
      ...
      >
        <button className={'bg-gray-200 rounded-[99px] b3'} onClick={temp}>취소</button>
        <CTAButton size={'small'} onClick={temp}>저장</CTAButton>
      </div>
      <button className={'mt-[40px] b4 text-gray-700'} onClick={temp}>로그 아웃</button>
    </div>
  )
}
