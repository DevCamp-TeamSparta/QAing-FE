...
export default function EmailSignup() {
  ...
  return (
    <section
      id="emailsignup"
      className=" flex font-pretendard font-normal  h-screen justify-center  bg-[#1E1E1E] "
    >
      <form
      ...
      >
        ...
        <div className="relative  top-[7px] mx-auto w-[292px] ">
          <header>
            <h2 className="relative font-bold bottom-[1px] right-[1px] mt-8 text-center text-[14px]  text-[#2D3138]">
              regular
            </h2>
          </header>
